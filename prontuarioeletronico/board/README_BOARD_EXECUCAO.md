...
- Entrega em andamento (MS-05):
  ...
  - [MS-05_RELATORIO_TECNICO_AUDIT_SERVICE.md](MS-05_RELATORIO_TECNICO_AUDIT_SERVICE.md)
- Proximo passo (CLN-02):
  - [CLN-02_PLANO_EXECUTAVEL_INTEGRACAO_TERMINOLOGIAS.md](CLN-02_PLANO_EXECUTAVEL_INTEGRACAO_TERMINOLOGIAS.md)
  - [CLN-02_RELATORIO_TECNICO_INTEGRACAO_TERMINOLOGIAS.md](CLN-02_RELATORIO_TECNICO_INTEGRACAO_TERMINOLOGIAS.md)
- Etapa atual (CLN-03):
  - [CLN-03_PLANO_EXECUTAVEL_HISTORICO_LONGITUDINAL.md](CLN-03_PLANO_EXECUTAVEL_HISTORICO_LONGITUDINAL.md)
  - [CLN-03_RELATORIO_TECNICO_HISTORICO_LONGITUDINAL.md](CLN-03_RELATORIO_TECNICO_HISTORICO_LONGITUDINAL.md)
- Proximo passo (LGPD-01):
  - [LGPD-01_PLANO_EXECUTAVEL_CONSENTIMENTO_BASE_LEGAL.md](LGPD-01_PLANO_EXECUTAVEL_CONSENTIMENTO_BASE_LEGAL.md)
...
- Proxima entrega (DOCKER-01):
  - [DOCKER-01_RELATORIO_TECNICO_DOCKERFILES_HEALTHCHECK.md](DOCKER-01_RELATORIO_TECNICO_DOCKERFILES_HEALTHCHECK.md)
- Proxima entrega (DOCKER-02):
  - [DOCKER-02_RELATORIO_TECNICO_COMPOSE_MULTISSERVICO.md](DOCKER-02_RELATORIO_TECNICO_COMPOSE_MULTISSERVICO.md)
- Proxima entrega (DOCKER-03):
  - [DOCKER-03_RELATORIO_TECNICO_SBOM_SCAN_IMAGENS.md](DOCKER-03_RELATORIO_TECNICO_SBOM_SCAN_IMAGENS.md)
- Proxima entrega (CICD-02):
  - [CICD-02_RELATORIO_TECNICO_PUBLISH_IMAGENS_REGISTRY.md](CICD-02_RELATORIO_TECNICO_PUBLISH_IMAGENS_REGISTRY.md)
- Proxima entrega (CICD-03):
  - [CICD-03_RELATORIO_TECNICO_CD_PROGRESSIVO_ROLLBACK.md](CICD-03_RELATORIO_TECNICO_CD_PROGRESSIVO_ROLLBACK.md)
- Proxima entrega (K8S-01):
  - [K8S-01_RELATORIO_TECNICO_DEPLOY_HOMOLOG.md](K8S-01_RELATORIO_TECNICO_DEPLOY_HOMOLOG.md)
- Proxima entrega (K8S-02):
  - [K8S-02_RELATORIO_TECNICO_HPA_SELF_HEALING_PDB.md](K8S-02_RELATORIO_TECNICO_HPA_SELF_HEALING_PDB.md)
- Proxima entrega (K8S-03):
  - [K8S-03_RELATORIO_TECNICO_CONFIGMAP_SECRET_NETWORKPOLICY_LIMITS.md](K8S-03_RELATORIO_TECNICO_CONFIGMAP_SECRET_NETWORKPOLICY_LIMITS.md)
...
- Baseline DOCKER-02 (issue #16) em `main`:
...
- Baseline CICD-02 (issue #18) em `main`:
...
- Baseline K8S-01 (issue #19) em `main`:
...
- Baseline K8S-03 (issue #21) em `main`:
  - Commit: `7493de87a409e03cadcc1de1da3c62d180e667e3`
  - Run de referencia: `23094869325`
  - URL: `https://github.com/JorgeJosePereiraOliveira/PROTOTIPO_PRONTUARIOELETRONICO/actions/runs/23094869325`
